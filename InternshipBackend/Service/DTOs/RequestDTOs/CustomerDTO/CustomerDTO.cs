...
namespace Service.DTOs.RequestDTOs.CustomerDTO
{
    public class CustomerDTO
    {
        ...
        [Required(ErrorMessage = "FullName is required"), EmailAddress(ErrorMessage = "Email is not valid")]
        public string Email { get; set; } = string.Empty;
        [Required(ErrorMessage = "Phone number is required"), Phone(ErrorMessage = "Phone number is not valid")]
