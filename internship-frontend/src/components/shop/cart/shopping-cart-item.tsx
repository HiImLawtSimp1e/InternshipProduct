      ...
      <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
        ...
        <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
          <div className="flex items-center border-gray-100">
            <span className="p-2 cursor-pointer rounded-l bg-gray-100 py-2 px-4 text-2xl duration-100 lg:py-1 lg:px-4 lg:text-lg hover:bg-blue-500 hover:text-blue-50">
              -
            </span>
            <input
              ...
              min="1"
            />
            <span className="p-2 cursor-pointer rounded-r bg-gray-100 py-2 px-4 text-2xl duration-100 lg:py-1 lg:px-4 lg:text-lg hover:bg-blue-500 hover:text-blue-50">
              +
            </span>
          </div>
